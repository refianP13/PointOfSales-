...
<div id="title">CATAT BARANG MASUK</div>
<div id="data">
...
<table id="dg" title="DATA BARANG MASUK" class="easyui-datagrid" style="height:250px"
    ...
    <div id="dlg" class="easyui-dialog" style="width:400px;height:280px;padding:10px 20px"
		...
		<form id="fm" method="post" novalidate>
            ...
            <div class="fitem">
             ...
             <div class="fitem">
			<label>Harga:</label>
		  	  <input name="hrg" class="easyui-numberbox" readonly="readonly"  required="true" >
			</div>
          <div class="fitem">
